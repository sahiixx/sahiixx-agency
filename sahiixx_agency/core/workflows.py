...
class WorkflowEngine:
    ...
    def seed_defaults(self) -> list[WorkflowDefinition]:
        ...
        trending_pipeline = WorkflowDefinition(
            ...
            description="Discover top repos, summarize, and queue a social post",
            trigger="schedule",
            schedule="0 6 * * *",
            steps=[
                WorkflowStep(
                    ...
                    action="dispatch",
                    target="agency",
                    intent_template="run discovery pipeline",
                    next_on_success="summarize",
                ),
                WorkflowStep(
                    id="summarize",
                    name="Summarize top repos",
                    action="dispatch",
                    target="agency",
                    intent_template="summarize discovery results",
                ...
                WorkflowStep(
                    ...
                    payload={
                        ...
                        "body": "Daily trending repo summary is ready for review.",
                    },
                ),
            ],
        )
